...
def play(word):
    print()
    print('Давай играть в угадайку слов (виселица)!')
    print('У тебя может быть 7 ошибок')
    word_completion = ['_' for i in word]
        ...
        if len(letter) == 1 and letter in "АБВГДЕЁЖЗИКЛМНОПРСТУФХЦЧШЩЪЬЭЫЮЯ":
            if letter in word:
                if letter not in guessed_letters:
                    ...
                    print(letter, "Такая буква уже была")
            else:
                guessed_letters.append(letter)
                tries -= 1
                ...
                print(display_hangman(tries))
                print(*word_completion)
                print("Названные буквы:")
                print(*guessed_letters)

        else:
            print("Нужна буква русского алфавита")
    print("Я загадала", word)
    print()
...
while again == 1:
    ...
    again = int(input("Хочешь сыграть еще раз? 1 = да, 0 = нет___"))
