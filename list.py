...
"""
# palindromes = [i for i in range(101, 1000) if str(i) == str(i)[::-1]]
# print(palindromes)


"""
списочное выражение, которая создает список содержащий квадраты чисел от 1 до 
n, а затем выводит его элементы построчно
"""
# li = [i ** 2 for i in range(1, int(input()) + 1)]
# for i in li:
#     print(i)
...
"""
Напишите программу, использующую списочное выражение, которая выводит
